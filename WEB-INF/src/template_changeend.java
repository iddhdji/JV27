...
public class template_changeend extends HttpServlet {
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		String con_nameStr = req.getParameter("content_name");
		...
		try {
			...
			query.append("UPDATE content_tbl SET content_name = '");
			query.append(con_nameStr);
