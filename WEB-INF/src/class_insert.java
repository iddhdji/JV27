...
public class class_insert extends HttpServlet {
	public void doPost(HttpServletRequest req, HttpServletResponse res)
		...
		String syussekiStr = req.getParameter("SYUSSEKI_NO");
		...
		try {
			...
			query2.append("set @i=0;");
			stmt.executeUpdate(query2.toString());
			query2.append("update class_table set syusseki_no = (@i:= @i+ 1 ) WHERE class_no = 'AT11A192' order by kana_1;");
			stmt.executeUpdate(query2.toString());
