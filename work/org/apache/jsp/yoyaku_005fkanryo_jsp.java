...
public final class yoyaku_005fkanryo_jsp extends org.apache.jasper.runtime.HttpJspBase
...
response.sendRedirect("syouhin_index.jsp");
  ...
  String URL ="jdbc:mysql://192.168.121.16/nhs90534db";
	...
	try{	// ロードに失敗したときのための例外処理
      ...
      out.write("    <input type=\"submit\" name=\"member\" value=\"会員リスト\" style=\"width: 170px; height: 40px; font-size: 30px; text-align: center; background-color: #fff; margin-left: 1150px;\">\r\n");
      out.write("  </form>\r\n");
      out.write("  </header>\r\n");
      out.write("\r\n");
      out.write("<nav>\r\n");
      out.write("<ul>\r\n");
      out.write("<li><a class=”current” href=\"reservation.html\">RESERVATION</a></li>\r\n");
 ...
 if(ERMSG != null){ 
      ...
      out.write("\r\n");
      out.write("<h2 class=\"text-primary font-weight-bold\">注文完了しました</h2>\r\n");
      out.write("  </body>\r\n");
