...
public final class friend_005fdelete_jsp extends org.apache.jasper.runtime.HttpJspBase
...
//  String URL ="jdbc:mysql://192.168.121.16/nhsxxxxxdb";
	...
	try{	// ロードに失敗したときのための例外処理
      ...
      System.out.println(SQL.toString());
		...
		hit_flag = 0;
		SQL = new StringBuffer();
		SQL.append("delete from friend_tbl where user_id= ");
		SQL.append(user_idStr);
      System.out.println(SQL.toString());
      ...
      out.write("    <hr>\r\n");
      out.write("    <br>\r\n");
      out.write("    <h3>以下のフレンドを削除しました。</h3>\r\n");
      out.write("        <p>");
      out.print( user_code );
      out.write("</p>\r\n");
      out.write("    <br>\r\n");
