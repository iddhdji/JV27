...
<li><a href="./profit.html">PROFIT</a></li>
  ...
  <body>
    <form  action="tyumon_uketuke.html" method="get">
<input type="submit" name="戻る" value="戻る" src="tyumon_uketuke.html" class="btn btn-primary btn-lg">
</form>
<h1 class="text-primary font-weight-bold">変更確認</h1>
<form  action="tyumon_henkou_kanryo.html" method="get">
<h2 class="text-primary font-weight-bold"></h2>
<table class="table">
  <tr>
    <td colspan="2"><a href="uketuke.html"><img src="image/yakisoba.jpg" alt="yakisoba"></a></td>
  </tr>
  <tr>
<td>名称</td>
<td>焼きそば</td>
    ...
    <tr>
<td>値段</td>
<td><input type="text" name="nedan" value="350"></td>
  </tr>
    <tr>
<td>個数</td>
...
<form action="tyumon_kakunin_error.html" method="get">
