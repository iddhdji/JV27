...
<h1 class="text-primary font-weight-bold">注文変更</h1>
<form action="tyumon_henkou_error.html" method="get">
<input type="submit" value="エラー表示">
</form>
<form action="tyumon_henkou_kakunin.html" method="get">
<table class="table">
  <tr>
    <td>注文コード</td>
    <td>名称</td>
  ...
  <tr>
    ...
    <td><input type="submit" name="henkou" value="変更する" class="btn btn-primary btn-lg"></td>
  </tr>
  <tr>
    <td>50001</td>
    <td>サラダ</td>
  ...
  <tr>
    ...
    <td>1</td>
    <td>2020/8/24 10:00</td>
    <td><input type="submit" name="henkou" value="変更する" class="btn btn-primary btn-lg" class="btn btn-primary btn-lg"></td>
  </tr>
</table>
</form>
