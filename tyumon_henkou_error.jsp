...
<table class="table">
  ...
  <tr>
    ...
    <td><input type="button" name="henkou" value="変更する" class="btn btn-primary btn-lg"></td>
  </tr>
  <tr>
    <td>50001</td>
    <td>サラダ</td>
  ...
  <tr>
    ...
    <td>1</td>
    <td>2020/8/24 10:00</td>
    <td><input type="button" name="henkou" value="変更する" class="btn btn-primary btn-lg" class="btn btn-primary btn-lg"></td>
  </tr>
</table>
</form>
